...
Ниже приведена **полная документация** по настройке каждого параметра, каждой команды и каждой возможности CLI.  
Документация дана на **трёх языках**: русском, английском и китайском.  
Все примеры, значения и флаги указаны максимально подробно.
