...
const DEFAULT_CONFIG = {
  ...
  profiles: {
    default: {
      temperature: 0.2,
      system: "Ты — опытный инженер-программист. Твои ответы кратки, точны и по существу. Используй инструменты для работы с файлами и системой. Return your response in JSON format."
    },
    creative: {
      temperature: 0.7,
...
export { DATA_DIR, HIST_FILE, CONF_FILE, CONF_FILE_ENC, LOG_DIR, UNDO_FILE, ASSIST_DIR, PIN_FILE, PLUGIN_DIR, PERM_FILE, TRUST_FILE, SESSION_DIR, CHECKPOINT_DIR, COST_FILE, GLOBAL_MEOW_MD, LEGACY_HIST_FILE, LEGACY_CONF_FILE, LEGACY_LOG_DIR, DEFAULT_CONFIG, I18N, t };
